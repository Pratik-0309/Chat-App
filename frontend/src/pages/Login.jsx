...
const Login = () => {
  ...
  const onSubmitHandler = (event) => {
    ...
    login(currState === "Sign up" ? "register" : "login", 
  ...
  return (
    ...
    >
      {/* Left */}
      <div className="text-white flex flex-col gap-4 max-md:hidden">
        <div className="flex items-center gap-3">
          <img src={assets.logo_icon} alt="logo" className="w-20" />{" "}
          <h1 className="text-5xl font-semibold">SnapTalk</h1>{" "}
        </div>
        <h1 className="text-gray-300 text-xl max-w-sm">
          Chat anytime, anywhere. Connect instantly with people around you.{" "}
        </h1>
      </div>
      {/* Right */}
      ...
      >
        ...
        {!isDataSubmitted && (
         ...
         border-gray-400 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
            />
            <input
        ...
        <button
          type="submit"
          className="py-3 bg-linear-to-r from-purple-400 to-violet-600 text-white 
